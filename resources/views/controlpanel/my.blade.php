    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('movies.search') }}">{{ __('messages.dashboard_title') }}</a></div>
                <div class="breadcrumb-item">{{ __('messages.my_title') }}</div>
            </div>
        </div>
    ...
    btn.addEventListener('click', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const deleteUrl = '{{ route('favorites.destroy', ['imdbId' => '__IMDB__']) }}'.replace('__IMDB__', imdbId);
