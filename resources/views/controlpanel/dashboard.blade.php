    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">{{ __('messages.dashboard_title') }}</a></div>
                <div class="breadcrumb-item">{{ __('messages.dashboard_section_title') }}</div>
            </div>
        </div>
                                ...
                                <div class="float-right mb-3">
                                    <div class="input-group">
                                        <input
                                            ...
                                            id="search-input"
                                            class="form-control"
                                            placeholder="{{ __('messages.dashboard_search_placeholder') }}"
